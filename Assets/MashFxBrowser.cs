...
/// </summary>
public class MashFxBrowser : MonoBehaviour
{
	
	static string message_from_web = "";
	...
	// default tab URL
	public string URL = "http://mashfx.herokuapp.com/unity";
	...
	void windowFunction (int windowID)
	{
		...
		browserRect = new Rect (4, 90 + 8, Width, Height);
		
		Rect headerRect = new Rect (4, 4, Width, 90 + 4);
